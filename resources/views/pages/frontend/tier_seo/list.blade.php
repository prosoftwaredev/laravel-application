...
@section('header')
    ...
    $(document).ready(function(){
        ...
        $('.sidebar-menu .tier_seo_menu .treeview-menu li.list').addClass('active');
    });
    </script>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Dashboard > Tier 2 SEO Campaigns</small>
                <a type="button" class="btn btn-info pull-right" href="/tier_seo/add"><i class="fa fa-plus"></i>&nbsp; Create Tier 2 Campaign</a>
            </h1>
