...
@section('header')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.sidebar-menu .tier_seo_menu').addClass('active');
            $('.sidebar-menu .tier_seo_menu').addClass('menu-open');
            $('.sidebar-menu .tier_seo_menu .treeview-menu li.add').addClass('active');
        });
    </script>
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Tier 2 SEO Campaigns
                <small>Dashboard > Tier 2 SEO Campaigns > Create Campaign</small>
            </h1>
                ...
                <div class="col-md-12">
                    <div class="box box-info create-seo-box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create Tier 2 SEO Campaign</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Tier 1 Campaign</label>
                                        </div>
                                        <div class="col-md-10">
                                            <select class="form-control">
                                                <option selected="selected">All Star Reviews YT Channel Campaign</option>
                                            </select>
                                            <span class="label label-warning">Select A Campaign Previously Created.</span>
                                        </div>
                                    </div>
                                </div>
