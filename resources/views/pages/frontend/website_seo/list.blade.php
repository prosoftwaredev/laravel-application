...
@section('header')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.sidebar-menu .website_seo_menu .treeview-menu li.list').addClass('active');
        });
    </script>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <a type="button" class="btn btn-info pull-right" href="/website_seo/add"><i class="fa fa-plus"></i>&nbsp; Create Website Campaign</a>
            </h1>
