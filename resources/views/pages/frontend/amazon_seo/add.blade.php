...
@section('header')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.sidebar-menu .amazon_seo_menu .treeview-menu li.add').addClass('active');
        });
    </script>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Dashboard > Amazon SEO Campaigns > Create Campaign</small>
            </h1>
                ...
                <div class="col-md-12">
                    <div class="box box-info create-seo-box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create Amazon SEO Campaign</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
