...
@section('header')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.sidebar-menu .youtube_seo_menu .treeview-menu li.add').addClass('active');
        });
    </script>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Dashboard > YouTube SEO Campaigns > Create Campaign</small>
            </h1>
                ...
                <div class="col-md-12">
                    <div class="box box-info create-seo-box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create YouTube SEO Campaign</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form role="form" method="post" action="add_campaign">
                                {!! csrf_field() !!}
                                <!-- text input -->
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="campaign_name" placeholder="Enter Campaign Name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" rows="3" name="campaign_url" placeholder="Enter URLs to backlink here, one per line"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" rows="3" name="campaign_keyword" placeholder="Enter keywords for backlink anchor text, one per line"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group content-category-part">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control content-categories" name="campaign_category">
