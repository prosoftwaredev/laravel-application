...
@section('header')
    ...
    $(document).ready(function(){
        ...
        $('.sidebar-menu .rss_feed_seo_menu .treeview-menu li.list').addClass('active');
    });
    </script>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Dashboard > RSS Feed SEO Campaigns</small>
                <a type="button" class="btn btn-info pull-right" href="/rss_feed_seo/add"><i class="fa fa-plus"></i>&nbsp; Create RSS Feed Campaign</a>
            </h1>
