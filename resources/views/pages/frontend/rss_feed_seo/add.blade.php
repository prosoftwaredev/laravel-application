...
@section('header')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.sidebar-menu .rss_feed_seo_menu').addClass('active');
            $('.sidebar-menu .rss_feed_seo_menu').addClass('menu-open');
            $('.sidebar-menu .rss_feed_seo_menu .treeview-menu li.add').addClass('active');
        });
    </script>
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                RSS Feed SEO Campaigns
                <small>Dashboard > RSS Feed SEO Campaigns > Create Campaign</small>
            </h1>
                ...
                <div class="col-md-12">
                    <div class="box box-info create-seo-box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create RSS Feed SEO Campaign</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <span class="label label-warning">System will check feed every 6 hours and pull new posts.</span>
                                        </div>
                                    </div>
                                </div>
