...
@section('header')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.sidebar-menu .google_map_seo_menu').addClass('active');
            $('.sidebar-menu .google_map_seo_menu').addClass('menu-open');
            $('.sidebar-menu .google_map_seo_menu .treeview-menu li.add').addClass('active');
        });
    </script>
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Google Map SEO Campaigns
                <small>Dashboard > Google Map SEO Campaigns > Create Campaign</small>
            </h1>
                ...
                <div class="col-md-12">
                    <div class="box box-info create-seo-box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create Google Map SEO Campaign</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <span class="label label-warning">System will retrieve Google Map Embed code and Google Map Link.</span>
                                        </div>
                                    </div>
                                </div>
