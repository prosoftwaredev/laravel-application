...
@section('header')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.sidebar-menu .google_map_seo_menu .treeview-menu li.list').addClass('active');
        });
    </script>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Dashboard > Google Map SEO Campaigns</small>
                <a type="button" class="btn btn-info pull-right" href="/google_map_seo/add"><i class="fa fa-plus"></i>&nbsp; Create Google Map Campaign</a>
            </h1>
